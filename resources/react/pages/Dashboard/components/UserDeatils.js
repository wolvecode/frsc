...
console.log(user);
    ...
    useEffect(() => {
      axios.post("/home/drivers/count",{id : user.id } )
      .then((res) => {
              ...
              <form action="" className="profile_details">
                <div className="form_group">
                  ...
                  <p>
                    ...
                    <input disabled type="text" value={myDate.toLocaleDateString()} />
                  </p>
                </div>

                <p>
                  <label htmlFor="" >Address</label>
                  <input disabled type="text" value={user.lga + "," + user.state} />
                </p>
                ...
                <div className="form_group">
                  ...
                  <p>
                    ...
                    <input disabled type="button" value="Edit Profile" className="submit_btn" />
                  </p>
