      ...
      <div className="form_row">
        ...
        <div className="form_group">
          ...
          <div className="relative">
            ...
            <select name="city" value={city} onChange={handleChange} className="user_input">
        ...
        <div className="form_group">
          ...
          <div className="relative">
            ...
            <select name="lga" value={lga} onChange={handleChange} className="user_input">
      ...
      <div className="form_row">
        ...
        <div className="form_group">
          ...
          <div className="relative">
            ...
            <select name="state" value={state} onChange={handleChange} className="user_input">
      ...
      <div className="form_row">
        ...
        <div className="form_group">
          ...
          <div className="relative" >
            ...
            <select name="city_2" value={city_2} onChange={handleChange} className="user_input">
              <option value="">Please select state</option>
              <option value="Male">Irewolede</option>
              <option value="Female">Orunla</option>
            </select>
        ...
        <div className="form_group">
          ...
          <div className="relative">
            ...
            <select name="lga_2" value={lga_2}  onChange={handleChange} className="user_input">
              <option value="">Please select LGA</option>
              <option value="Male">Ilorin-west</option>
              <option value="Female">Orunla</option>
            </select>
      ...
      <div className="form_row">
        ...
        <div className="form_group">
          ...
          <div className="relative">
            ...
            <select name="state_2" id="" onChange={handleChange} value={state_2} className="user_input">
              <option value="">Please select state</option>
              <option value="Male">Kwara</option>
              <option value="Female">Orunla</option>
            </select>
